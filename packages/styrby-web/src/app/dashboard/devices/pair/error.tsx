...
/**
 * Error boundary for the device pairing page.
 *
 ...
 */
export default function PairingError({ error, reset }: ErrorProps) {
  return (
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h2 className="text-xl font-semibold text-zinc-100 mb-2">
          Failed to load pairing page
        </h2>
        <p className="text-zinc-400 mb-6">
          {error.message || 'An unexpected error occurred while loading the pairing page.'}
        </p>
