...
/**
 * Error boundary for the Pricing page.
 *
 * Catches runtime errors in the pricing route and displays a user-friendly
    ...
    <div className="min-h-screen bg-zinc-950 flex items-center justify-center px-4">
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-zinc-400 mb-6">
          {error.message || 'Something went wrong loading pricing information.'}
        </p>
