...
export default function VoiceDocsPage() {
  ...
  return (
    <article>
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="w-full text-sm text-left text-muted-foreground">
          ...
          <tbody className="divide-y divide-border">
            ...
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Audio storage</td>
              <td className="py-2">Never stored by Styrby</td>
            </tr>
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Audio routing</td>
              <td className="py-2">Phone to your transcription endpoint directly</td>
            </tr>
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Transcription service</td>
      ...
      {/* Requirements */}
      <h2 className="mt-10 text-xl font-semibold text-foreground scroll-mt-20" id="requirements">
        Requirements
      </h2>
      <p className="mt-3 text-muted-foreground">
      ...
      <ul className="mt-3 list-disc list-inside space-y-2 text-muted-foreground">
        <li>
          <strong className="text-foreground/75">A transcription endpoint</strong>{" "}
        ...
        <li>
          <strong className="text-foreground/75">An API key or access token</strong>{" "}
          for that service, if required.
        </li>
      </ul>
      <p className="mt-3 text-muted-foreground">
        The recommended service is the{" "}
        <strong className="text-foreground/75">OpenAI Whisper API</strong> at
      ...
      <h2 className="mt-10 text-xl font-semibold text-foreground scroll-mt-20" id="setting-up-with-openai-whisper">
      ...
      <ol className="mt-3 list-decimal list-inside space-y-2 text-muted-foreground">
        <li>
          Sign in at{" "}
          <strong className="text-foreground/75">platform.openai.com</strong>
        </li>
        <li>
          Go to{" "}
        ...
        <li>
          Click <strong className="text-foreground/75">Create new secret key</strong>,
          name it &quot;Styrby Voice&quot;, and copy the key
        </li>
        <li>
          Open the Styrby mobile app and go to{" "}
          <strong className="text-foreground/75">Settings &gt; Voice Input</strong>
        </li>
        <li>
          Set <strong className="text-foreground/75">Transcription Endpoint</strong>{" "}
          to:
          <pre className="mt-2 overflow-x-auto rounded-lg bg-card p-3 text-sm text-foreground/75 border border-border">
{`https://api.openai.com/v1/audio/transcriptions`}
          </pre>
        </li>
        <li>
          Set <strong className="text-foreground/75">API Key</strong> to the key you
          copied in step 3
        </li>
        <li>
          Set <strong className="text-foreground/75">Model</strong> to{" "}
          <code className="rounded bg-secondary px-1.5 py-0.5 text-xs text-foreground/75">
            whisper-1
          </code>
        </li>
        <li>
          Tap <strong className="text-foreground/75">Save</strong> and then{" "}
          <strong className="text-foreground/75">Test Microphone</strong> to confirm
          transcription works
        </li>
      </ol>
      ...
      {/* Self-hosted */}
      <h2 className="mt-10 text-xl font-semibold text-foreground scroll-mt-20" id="self-hosted-transcription">
      ...
      <h3 className="mt-6 text-lg font-medium text-foreground/90 scroll-mt-20" id="whisper-cpp-fastest-on-apple-silicon">
...
./server -m models/ggml-base.en.bin --port 8080`}
      ...
      <ul className="mt-2 space-y-1 text-muted-foreground text-sm list-disc list-inside">
        <li>
          <strong className="text-foreground/75">Transcription Endpoint:</strong>{" "}
          <code className="rounded bg-secondary px-1.5 py-0.5 text-xs text-foreground/75">
            http://your-mac-ip:8080/inference
          </code>
        </li>
        <li>
          <strong className="text-foreground/75">API Key:</strong> leave blank (no
      ...
      <h3 className="mt-6 text-lg font-medium text-foreground/90 scroll-mt-20" id="faster-whisper-docker">
...
{`http://your-server-ip:9000/asr`}
      ...
      <h2 className="mt-10 text-xl font-semibold text-foreground scroll-mt-20" id="configuration-options">
        Configuration Options
      </h2>
      <p className="mt-3 text-muted-foreground">
        All voice settings are under{" "}
        <strong className="text-foreground/75">Settings &gt; Voice Input</strong> in
      ...
      <div className="mt-4 overflow-x-auto">
        <table className="w-full text-sm text-left text-muted-foreground">
          ...
          <tbody className="divide-y divide-border">
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Input mode</td>
            ...
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Transcription endpoint</td>
              <td className="py-2 pr-4">URL string</td>
              <td className="py-2 text-xs">
                Must accept{" "}
                <code className="rounded bg-secondary px-1 py-0.5 text-xs text-foreground/75">
                  multipart/form-data
                </code>{" "}
                with a{" "}
                <code className="rounded bg-secondary px-1 py-0.5 text-xs text-foreground/75">
            ...
            <tr>
              <td className="py-2 pr-4 text-foreground/75">API key</td>
            ...
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Model</td>
              <td className="py-2 pr-4">String</td>
              <td className="py-2 text-xs">
                Passed as the{" "}
                <code className="rounded bg-secondary px-1 py-0.5 text-xs text-foreground/75">
            ...
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Language</td>
            ...
            <tr>
              <td className="py-2 pr-4 text-foreground/75">Request timeout</td>
      ...
      {/* Troubleshooting */}
      <h2 className="mt-10 text-xl font-semibold text-foreground scroll-mt-20" id="troubleshooting">
        Troubleshooting
      </h2>

      <h3 className="mt-6 text-lg font-medium text-foreground/90 scroll-mt-20" id="no-transcription-returned">
      ...
      <h3 className="mt-6 text-lg font-medium text-foreground/90 scroll-mt-20" id="garbled-or-inaccurate-transcription">
      ...
      <h3 className="mt-6 text-lg font-medium text-foreground/90 scroll-mt-20" id="request-timeout">
        Request timeout
      </h3>
      <ul className="mt-2 list-disc list-inside space-y-2 text-muted-foreground">
        <li>
      ...
      <h3 className="mt-6 text-lg font-medium text-foreground/90 scroll-mt-20" id="voice-input-option-not-available">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        ...
        <strong className="text-foreground/75">Pricing</strong> page on the web
        dashboard.
      </p>
